      ...
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            ...
            n printer took a galley of type and scrambled it to make a type specimen book. It
            <hr>
            <div class="main-comment">

              <div id="error_status"></div>
              <textarea class="comment_text  form-control" rows="3"></textarea>
               <button type="button" class="btn btn-primary add_comment_btn"
               id="add_comment_btn">Comment</button>
            </div>
          </div>
        </div>
      </div>
